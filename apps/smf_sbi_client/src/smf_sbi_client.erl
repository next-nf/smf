...
handle_call({setup, Config}, _From, _State) ->
    _ = smf_sbi_client_config:validate_options(
	  fun smf_sbi_client_config:validate_option/2, Config),
    {reply, ok, #{}};
...
upf_selection(Data, State) ->
    case application:get_env(smf_sbi_client, upf_selection, #{}) of
